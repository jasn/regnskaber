...
def producer_scan(process_count=4,
    ...
    with AArlCollection() as aarl:
        ...
        queue = SimpleQueue()
        processes = [Process(target=consumer_insert,
                             args=(queue, aarl, unit_handler),
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=(
        ...
        'The date interval given is half open: i.e. [FROM-DATE,TO-DATE).'))
